...
class MainFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"FormatJson", pos = wx.DefaultPosition, size = wx.Size( 546,434 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.m_paste_btn = wx.Button( self, wx.ID_ANY, u"Paste", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer4.Add( self.m_paste_btn, 0, wx.ALL, 10 )
		
		self.m_copy_btn = wx.Button( self, wx.ID_ANY, u"Copy", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer4.Add( self.m_copy_btn, 0, wx.ALL, 10 )
		
		self.m_transfer_btn = wx.Button( self, wx.ID_ANY, u"transfer", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer4.Add( self.m_transfer_btn, 0, wx.ALIGN_BOTTOM|wx.ALL, 10 )
